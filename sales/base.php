<div class="header bg-dark">
	<img class="img-fluid w-100 mt-1 ml-1" src="../images/logo.png" >
</div>
<div class="sidebar">
	...
	<button id="sidebar_button" type="button" data-toggle="popover" title="Sales Record" data-content="Bahala ka diha." data-placement="bottom"><i class="fas fa-question"></i> Help</button>
