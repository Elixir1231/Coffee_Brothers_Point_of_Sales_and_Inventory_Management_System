...
<div class="sidebar">
	...
	<button id="sidebar_button" type="button" data-toggle="popover" title="Customer Management" data-content="Bahala ka diha." data-placement="bottom"><i class="fas fa-question"></i> Help</button>
