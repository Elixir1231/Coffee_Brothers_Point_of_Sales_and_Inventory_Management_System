...
<div class="sidebar">
	...
	<button id="sidebar_button" data-toggle="popover" title="Product Deliveries" data-content="Bahala ka diha. " data-placement="bottom"><i class="fas fa-question"></i> Help</button>
