                    ...
                    <tbody class="table-hover">
                        ...
                        <tr class="table-active">
                            ...
                            <td>
                                ...
                                <button type="button" name="add_ingredients" style='font-size:10px; border-radius:5px;padding:4px;' title="Add Ingredients" class="add_ingredients btn btn-primary btn-xs" data-toggle="modal" data-target="#addIngredientModal" data-product-id="<?php echo $row['product_no']; ?>"><i class="fas fa-plus"></i></button>
