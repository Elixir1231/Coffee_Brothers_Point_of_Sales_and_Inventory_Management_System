...
<div class="sidebar">
	<div class=" m-3"><h3><i class="fas fa-tachometer-alt"></i> Dashboard</h3></div>
	<button id="sidebar_button" onclick="window.location.href='../products/products.php'"><i class="fas fa-list-ul"></i> Product List</button>
	<button id="sidebar_button"onclick="window.location.href='../products/ingredients.php'"><i class="fas fa-list-ul"></i> Ingredient List</button>
	<button id="sidebar_button" onclick="window.location.href='../delivery/add_delivery.php'"><i class="fas fa-truck"></i> Delivery</button>
	<button id="sidebar_button" data-toggle="popover" title="Product Management" data-content="Bahala ka diha." data-placement="bottom"><i class="fas fa-question"></i> Help</button>
