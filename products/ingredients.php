            ...
            <div class="table-responsive mt-2 pl-5 pr-5">
                <table class="table table-striped table-bordered" id="ingredient_table">
                    ...
                    <tr class="table-active">
                        ...
                        <td>
                            <a name="edit" title="Edit" style='font-size:10px; border-radius:5px;padding:4px;' href="update_ingredient.php?id=<?php echo $row['ingredient_id'];?>" class="btn btn-info btn-xs"><i class="fas fa-user-edit"></i></a>
                            ...
                            <button type="button" name="delete" title="Delete" style='font-size:10px; border-radius:5px;padding:4px;' data-id="<?php echo $row['ingredient_id'];?>" class="delete btn btn-danger btn-xs" title="Delete"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
                    <?php } ?>
                    </tbody>
